...
<style type="text/css">
body{font:12px/1.5 Tahoma,Helvetica,Arial,sans-serif;position:absolute; top:0px; left:0px;}
...
.j_Slide{margin:0;border:5px #c2dae5 solid;width:400px;height:300px;overflow:hidden;position:relative;-webkit-border-radius:0px;}
...
.j_Slide1 .hd .handel li a,.j_Slide1 .hd .handel li a:link,.j_Slide1 .hd .handel li a:active,.j_Slide1 .hd .handel li a:visited{text-decoration:none;padding:0px 0px;}
...
//打开 images 目录
  ...
  $dir_1 = opendir("D:/smartfarm/PHP/PHPWeb/pictures_1");
$j=null;
...
<div class="j j_Slide loading">
	<ol class="tb-slide-list">
		<?php 
        for($y=2;$y<$j;$y++){
        $qutu_1="select root from pictures_1 where id=$y"; 
        $result_1=mysql_query($qutu_1,$con);
        while($row_1=mysql_fetch_array($result_1)){
         ?>
		<li class="J_ECPM"><target="_blank"><?php echo "<img src=\"".$row_1["root"]."\"/>";?></a></li>
		<?php } }?>
	</ol>
</div>
